...
LOCALIZED_MESSAGES = {
    ...
    "CHINESE": {
        "waiting": "等待字幕开始...",
        "switching": "正在切换语言...等待新字幕",
        "instructions": "点击任意位置启用音频播放"
    },
    "THAI": {
        "waiting": "กำลังรอคำบรรยายเริ่มต้น...",
        "switching": "กำลังเปลี่ยนภาษา...รอคำบรรยายใหม่",
        "instructions": "คลิกที่ใดก็ได้เพื่อเปิดใช้งานการเล่นเสียง"
    },
    "VIETNAMESE": {
    ...
    "KHMER": {
        "waiting": "កំពុងរង់ចាំចំណងជើងរងចាប់ផ្តើម...",
        "switching": "កំពុងប្តូរភាសា... កំពុងរង់ចាំចំណងជើងរងថ្មី",
        "instructions": "ចុចកន្លែងណាមួយដើម្បីបើកការចាក់សំឡេង"
    },
    "LAO": {
        "waiting": "ກຳລັງລໍຖ້າຄຳບັນຍາຍເລີ່ມຕົ້ນ...",
        "switching": "ກຳລັງປ່ຽນພາສາ... ລໍຖ້າຄຳບັນຍາຍໃໝ່",
        "instructions": "ຄລິກບ່ອນໃດກໍໄດ້ເພື່ອເປີດການຫຼິ້ນສຽງ"
    },
    "HINDI": {
